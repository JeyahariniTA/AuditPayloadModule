...
public class AuditPayloadServiceImpl implements AuditPayloadService {
	...
	@Override
	public List<AuditPayload> fetchAuditPayloadByEntityId(int id) {
		List<AuditPayload> list = new ArrayList<>();
	...
	public List<AuditPayload> getByUserNameAndDate(String userName, Date startDate, Date endDate) {
		return auditPayloadRepository.findByUserNameAndLogDateBetween(userName, startDate, endDate);
	}

	@Override
	public List<AuditPayload> getByEntityTypeAndDate(String entityType, Date startDate, Date endDate) {
		return auditPayloadRepository.findByEntityTypeAndLogDateBetween(entityType, startDate, endDate);
	}
